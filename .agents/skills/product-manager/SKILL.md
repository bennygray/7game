...
5. 如某维度缺乏信息无法给出有意义选项 → 退化为开放式提问，标注"[信息不足，开放提问]"
...
| # | 维度 | 建议选项式提问模板 |
|---|------|-------------------|
| Q1 | 核心体验 | "做完这个，玩家体验的主要变化是？我看到几种可能：(a) [选项A] (b) [选项B] (c) 你有其他想法？" |
| Q2 | 系统边界 | "这个系统一定**不做**什么？参考 [相关现有系统]，建议排除：(a) [排除项A] (b) [排除项B] (c) 其他边界？" |
| Q3 | 触发方式 | "什么情况下触发？(a) 系统自动 (b) 玩家指令触发 (c) 混合 (d) 其他？" |
| Q4 | 系统关系 | "它和 [最相关现有系统] 的关系？(a) 扩展 (b) 替代 (c) 并行但数据互通 (d) 其他？" |
| Q5 | 成功标准 | "怎么判断做成了？(a) [可观察行为A] (b) [可观察行为B] (c) 你的标准？" |

...
| **v0.5.1** | GS | 弟子性别系统（gender字段·性别化名字·代词·AI注入·迁移） | v7 | ✅ 完成 |
| **v0.6.0** | I-beta | 社交事件系统（三维关系重构·性取向·AI邀约·道侣/结拜/宿敌） | v8 | 📋 SPM 进行中 |
...
| 2026-04-02 | v2.2 | +Phase GS（弟子性别系统）注册到 §5 路线图，存档版本 v7 |
